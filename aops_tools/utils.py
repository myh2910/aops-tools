...
href="{user_profile(data['poster_id'])}">
<img class="cmty-avatar no-print" src="https:{data['avatar']}" \
width="80" height="80">
</a>
<div class="cmty-post-username">
<a title="{data['username']}\nClick to view user profile." \
href="{user_profile(data['poster_id'])}">{data['username']}</a>
</div>
...
<span class="cmty-pm-from-post"><span><span class="aops-font">V</span>PM\
</span></span>
<span class="cmty-post-date">{post_time}</span>"""
	if data['thanks_received']:
		content += f"""
<span class="cmty-post-thank-count"> • {data['thanks_received']} \
<span class="aops-font">Y</span></span>"""
	content += f"""
</div>
</div>
...
<img class="cmty-avatar" src="https:{post_data['poster_avatar']}" \
width="30" height="30">
</div>
